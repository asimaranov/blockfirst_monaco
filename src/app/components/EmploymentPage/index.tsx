    ...
    <main className="border-accent flex min-h-screen w-full flex-col border-r border-l">
      ...
      <div className="flex flex-1 flex-row border-accent">
        ...
        <div className=" relative flex flex-1 flex-col">
          <div className="bg-background sticky top-0 z-[2] grid items-center gap-10 px-8 py-3.5 grid-cols-[calc(50*var(--spacing))_calc(35*var(--spacing))_calc(28*var(--spacing))_calc(20*var(--spacing))_1fr]">
