...
export function TaskCard({
  ...
  return (
    <div className="bg-muted border-accent relative -mx-16 flex h-83 w-[calc(100%*var(--spacing)*32)] flex-row rounded-sm border-y">
        ...
        <div className="mt-auto flex flex-row items-center gap-4">
          <div className="flex flex-col gap-3.5">
            ...
            <div className="flex flex-row items-center gap-2">
              ...
              <span className="text-base font-medium">{completionCount}</span>
            </div>
          </div>
