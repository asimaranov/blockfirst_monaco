    ...
    <>
      {status == 'available' ? (
        ...
        >
          ...
          <span className="text-xs leading-4 whitespace-nowrap text-[#195AF4]">
            В процессе
          </span>
        </div>
      ) : (
            ...
            <div className="mt-6 flex flex-col sm:mt-auto sm:flex-row sm:items-center">
              <div className="grid grid-cols-2 gap-4 sm:flex sm:flex-row sm:gap-8">
                <div className="flex flex-col gap-3.5">
                  <span className="text-secondary text-xxs rounded-[6px] bg-[#14171C] px-3 py-1.75 leading-2.5 whitespace-nowrap uppercase sm:w-fit sm:rounded-[0.3472vw]">
                    Выполнили задачу
                  </span>
                  <div className="flex flex-row items-center gap-2">
                    <svg
            ...
            <div className="mt-6 flex flex-col sm:mt-auto sm:flex-row sm:items-center">
              <div className="grid grid-cols-2 gap-5">
                <div className="flex flex-col gap-3">
                  <span className="text-secondary text-xxs hidden w-fit min-w-25 rounded-[0.3472vw] bg-[#14171C] px-3 py-1.75 leading-2.5 whitespace-nowrap uppercase sm:block">
                    Выполнили
                  </span>
                  <span className="text-secondary text-xxs rounded-[0.3472vw] bg-[#14171C] px-3 py-1.75 leading-2.5 whitespace-nowrap uppercase sm:hidden sm:w-fit sm:rounded-[0.3472vw]">
                    Выполнили задачу
                  </span>
                  <div className="flex flex-row items-center gap-2">
                    <svg
