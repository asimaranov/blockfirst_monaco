...
export function TaskElement({
  ...
  const taskId = children[0].props?.text?.text;

  const labels = ['Глава 1', 'Тема 2', 'Урок 2'];

  return (
    <PlateElement
      className={cn(
        'bg-muted border-accent relative -mx-16 flex h-83 w-[calc(100%*var(--spacing)*32)] rounded-sm border-y',
        className
      )}
      style={{
      ...
      <div className="flex w-full flex-row">
          ...
          <div className="flex h-full flex-col bg-[url('/grids/task-grid.svg')] bg-contain bg-bottom p-8">
            <div className="text-secondary/50 flex flex-row justify-between text-xs">
              ...
              <div className="flex flex-row items-center gap-1">
                ...
                <span className="text-foreground text-xs">15.03.2025</span>
              </div>
              {/* Centered image */}
            </div>
            ...
            <div className="relative mt-auto flex flex-col items-center">
              <div className="relative">
                ...
                <svg
                  ...
                  className="absolute bottom-0 left-1/2 -translate-x-[calc(50%)]"
                >
                  <path
        ...
        <div className="flex w-full flex-col p-8">
          ...
          <div className="flex flex-col gap-4">
            <span className="text-2xl">Комментарии излишни</span>
            <span className="text-secondary text-sm">
              Не все комментарии одинаково полезны! Иногда они появляются в
              коде, если программист не уверен в какой-то строчке и хочет
              вернуться к ней позднее. Так и с этой задачей получилось: в ней
              один лишний ...
            </span>
          </div>
          ...
          <div className="mt-auto flex flex-row items-center gap-4">
            <div className="flex flex-col gap-3.5">
              ...
              <div className="flex flex-row items-center gap-2">
                ...
                <span className="text-base font-medium">1 207+</span>
              </div>
            </div>
            ...
            <button className="bg-primary ml-auto flex flex-row items-center rounded-[5.2083vw] px-15.75 py-3 cursor-pointer">
              Выполнить
              <svg
                width="21"
                height="20"
