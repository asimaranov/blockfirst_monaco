      ...
      leftContent={
        <div className="flex flex-col">
          ...
          <div className="flex flex-row items-center gap-2 pt-10 sm:hidden">
            <div className="flex flex-1 flex-row gap-2 text-sm items-center justify-center">
              <div>Реф. ссылка</div>
              <CopyButton appearanceType="near" className="flex items-center" />
            </div>
            <div className="flex-1 text-sm flex flex-row justify-center border-[#195AF4] border rounded-full py-2">
              Блогерам
              <svg
                width="21"
                height="20"
