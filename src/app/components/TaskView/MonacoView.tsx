  ...
  return (
    ...
    >
      ...
      <div className="flex flex-grow flex-col">
        ...
        {success && (
          <div className="border-t-success border-x-accent relative flex flex-grow flex-col gap-16 border-x border-t bg-[#111B1D] px-8 py-6">
            <svg
              width="32"
              height="12"
              viewBox="0 0 32 12"
        ...
        <div className="border-accent flex flex-row items-center justify-center border-t shadow-lg">
          <div className="flex w-full flex-col">
            <div className="flex w-full flex-row px-8 py-6">
              ...
              <button
                className="bg-primary ml-auto flex cursor-pointer gap-2 rounded-[5.2083vw] px-6 py-3 text-sm"
                onClick={() => {
                  setSuccess({
                    advancedTasksCompleted: true,
                  });
