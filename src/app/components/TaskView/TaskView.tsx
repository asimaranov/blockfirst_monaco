        ...
        {!collapsed ? (
          ...
          >
            <div className="flex flex-row items-center px-8 py-6">
              <Link
                href={`/lesson/${lessonId}`}
                className="group/back-button hidden cursor-pointer p-2.5 sm:flex"
                onClick={handleClose}
              >
                <svg
                  width="20"
              ...
              <button
                className="group/hide-button hidden cursor-pointer rounded-[0.4167vw] bg-[#14171C] p-2.5 sm:flex"
