        ...
        <div className="flex flex-1 flex-col gap-8">
          ...
          <div className="flex flex-1 flex-col gap-8">
            <div className="relative flex h-82 w-85 flex-col items-center justify-center gap-4">
              <div className="flex items-center justify-center p-5 bg-foreground rounded-3xl">
                <QRCodeSVG
                  value={paymentUri}
                  size={200}
                  fgColor="#01050d"
            ...
            <div className="text-secondary flex h-12 w-full items-center justify-between rounded-[0.463vw] bg-[#14171C] px-5 text-center text-sm opacity">
              0x9702230a8ea536...3d4df4a8c7
              <button
                className="cursor-pointer button group"
                onClick={handleCopy}
              >
                {isCopied ? <Image src={CopiedIcon} alt="Copied" /> : <CopyIcon />}
              </button>
            </div>
          </div>
        </div>
