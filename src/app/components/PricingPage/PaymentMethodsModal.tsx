  ...
  return (
    <div className="mx-5 py-6 sm:mx-10 sm:py-8">
      ...
      <div className="mt-5 flex items-center justify-between">
        ...
        <button
          className={cn(
            'text-foreground flex cursor-pointer items-center rounded-full border border-[#195AF4] px-6 py-2.5 text-sm transition-colors hover:bg-[#195AF4]',
...
const PaymentMethodsModal = ({
  ...
  const [isTetherPayment, setIsTetherPayment] = useState(false);
  const {
