...
const LessonStates = {
  ...
  skipped: (
    <InfoPopover
      title="Задача не пройдена"
      content="Вы не завершили практическую задачу из урока. Вы можете вернуться к ней позже, но без её выполнения “зачет” будет недоступен."
      popoverClassName="w-78 mr-4"
      hideOnHover
      icon={
        <svg
          width="20"
...
export function CourseModule({
  ...
  return (
    <div className="flex w-full flex-col">
      ...
      <div className="mt-6 mr-4 ml-6 flex">
