...
export default function MobilePremiumTopbar({ text }: { text: string }) {
  return (
    <div className="border-accent flex w-full flex-row items-center gap-2 border-b px-5 py-6 text-base sm:hidden sm:text-xl">
      <Link href="/premium">
        <svg
          width="20"
          height="20"
