  ...
  return (
    <div className="group relative">
      <svg
        ...
        className={cn(
          'text-secondary cursor-pointer transition delay-100 duration-300 ease-in-out group-hover:text-[#F2F2F2] h-4 w-4',
          !title && !content && 'group-hover:text-secondary cursor-default'
        )}
      >
      ...
      <div className="relative z-50">
        <div className="invisible absolute top-4 -right-8 flex w-112 flex-col bg-[#1D2026] p-6 opacity-0 transition-all transition-discrete delay-100 duration-300 ease-in-out group-hover:visible group-hover:opacity-100">
          <div className="text-sm pb-3 text-foreground">{title}</div>
